...
CUSTOMIZE="\
process.MINIAODSIMoutput.outputCommands.append('keep *_*_*_HLT'); \
process.MINIAODSIMoutput.outputCommands.append('keep *_*_*_SIM'); \
...
process.MINIAODSIMoutput.outputCommands.extend(process.L1TriggerFEVTDEBUG.outputCommands); \
process.MINIAODSIMoutput.outputCommands.extend(process.MicroEventContentMC.outputCommands); \
process.load('HLTrigger.Configuration.HLTPhase2TDR_EventContent_cff'); \
process.MINIAODSIMoutput.outputCommands.extend(process.HLTPhase2TDR.outputCommands); \
"
...
#CUSTOMIZE="\
#process.MINIAODSIMoutput.outputCommands.append('keep hltGsfElectron*_gedGsfElectron*_*_*') \n\
#process.MINIAODSIMoutput.outputCommands.append('keep hltGsfTracks_electronGsfTracks_*_*') \n\
#process.MINIAODSIMoutput.outputCommands.append('keep hltPhoton*_gedPhoton*_*_*') \n\
...
#process.MINIAODSIMoutput.outputCommands.append('keep hltSuperClusters_particleFlowSuperCluster*_*_*') \n\
#process.MINIAODSIMoutput.outputCommands.append('keep hltSuperClusters_*_*_*') \n\
#process.MINIAODSIMoutput.outputCommands.append('keep hltTracks_generalTracks_*_*') \n\
#process.MINIAODSIMoutput.outputCommands.append('keep hltTracks_trackExtenderWithMTD_*_*') \n\
#process.MINIAODSIMoutput.outputCommands.append('keep *_tofPID_*_*') \n\
#process.MINIAODSIMoutput.outputCommands.append('keep *_mtdTrackQualityMVA_*_*') \n\
#"
